...
private:
    int *arr = NULL;
    int size = 0; // stores current number of non-null elements
    int capacity; // stores maximum size of current array
...
public:
	...
	*/
	virtual std::string getArray() const; // DONE

	/*
	* Returns the number of elements which have been added to the array.
	*/
	virtual int getSize() const; // DONE
	...
	*/
	virtual bool addToArray(int value); // DONE
	...
	*/
	virtual bool createArray(int capacity); // DONE

	/*
	* Resets the array to an empty or NULL state.
	*/
	virtual void clear(); // DONE
    bool isEmpty();
};
